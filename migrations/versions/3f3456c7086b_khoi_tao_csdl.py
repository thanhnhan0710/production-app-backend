...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_machine_statuses_status_id'), 'machine_statuses', ['status_id'], unique=False)
    ...
    sa.Column('type_name', sa.String(length=100), nullable=False, comment='VD: Sợi Polyester, Sợi Cotton, Hóa chất...'),
    ...
    sa.Column('category_name', sa.String(length=100), nullable=False, comment='VD: Nhà cung cấp sợi, Nhà cung cấp phụ tùng...'),
    sa.Column('description', sa.Text(), nullable=True),
    ...
    sa.Column('polymorphic_type', sa.String(length=50), nullable=False),
    sa.ForeignKeyConstraint(['area_id'], ['areas.area_id'], ),
    sa.ForeignKeyConstraint(['machine_type_id'], ['machine_types.machine_type_id'], ),
    sa.ForeignKeyConstraint(['status_id'], ['machine_statuses.status_id'], ),
    ...
    sa.ForeignKeyConstraint(['product_type_id'], ['product_types.product_type_id'], ),
    ...
    sa.ForeignKeyConstraint(['category_id'], ['supplier_categories.category_id'], ),
    ...
    op.create_table('dyeing_machines',
    sa.Column('machine_id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['department_id'], ['departments.department_id'], ),
    sa.ForeignKeyConstraint(['group_id'], ['employee_groups.group_id'], ),
    ...
    sa.Column('dtex', sa.Integer(), nullable=True),
    sa.Column('filament', sa.String(length=20), nullable=True),
    sa.Column('min_stock_level', sa.Float(), nullable=True),
    sa.Column('kg_per_bobbin', sa.Float(), nullable=True),
    sa.ForeignKeyConstraint(['supplier_id'], ['suppliers.supplier_id'], ),
    sa.ForeignKeyConstraint(['type_id'], ['material_types.type_id'], ),
    ...
    op.create_table('weaving_machines',
    sa.Column('machine_id', sa.Integer(), nullable=False),
    ...
    sa.Column('role', sa.Enum('ADMIN', 'MANAGER', 'STAFF', 'WORKER', 'WAREHOUSE', name='userrole'), nullable=False),
    sa.ForeignKeyConstraint(['employee_id'], ['employees.employee_id'], ),
    ...
    sa.ForeignKeyConstraint(['basket_id'], ['baskets.basket_id'], ),
    sa.ForeignKeyConstraint(['machine_id'], ['weaving_machines.machine_id'], ),
    sa.ForeignKeyConstraint(['shift_id'], ['shifts.shift_id'], ),
...
def downgrade() -> None:
    ...
    op.drop_table('weaving_machines')
