...
def upgrade() -> None:
    ...
    # [FIX 1] Thử tạo bảng, nếu bảng đã tồn tại thì bỏ qua
    try:
    ...
    # [FIX 2] Thử tạo index cho cột date, nếu có rồi thì bỏ qua
    try:
        op.create_index(op.f('ix_weaving_daily_productions_date'), 'weaving_daily_productions', ['date'], unique=False)
    except Exception:
        pass

    # [FIX 3] Thử tạo index cho cột id, nếu có rồi thì bỏ qua
    try:
